# WEB103 Project 1 - *Sportify*

Submitted by: **Danh Nguyen**

About this web app: **SSportify is a lightweight web app for discovering upcoming sports events at a glance.  
...
- [x] "Surprise Me !!!" Button instantly picks a random event from the current list and opens its detail page, offering a quick, playful way to discover something new.
